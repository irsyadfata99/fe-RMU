...
export const NAVIGATION: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Barang Return",
        href: "/dashboard/laporan/return",
        icon: RotateCcw,
        roles: ["ADMIN"],
      },
      {
        label: "Barang Paling Laku",
        href: "/dashboard/laporan/best-seller",
        icon: TrendingUp,
        roles: ["ADMIN"],
      },
      {
      ...
      },
      {
        ...
        href: "/dashboard/laporan/hutang",
        icon: CreditCard,
        roles: ["ADMIN"],
      },
      {
        label: "Piutang Member",
        href: "/dashboard/laporan/piutang",
        icon: CreditCard,
        roles: ["ADMIN"],
      },
      {
        label: "Bonus Point",
        href: "/dashboard/laporan/point",
        icon: Gift,
        roles: ["ADMIN"],
      },
    ],
